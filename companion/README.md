...
The terminal prints a loopback URL and a new random token. Open **Local** in DevKit, enter both values and select **Connect**. The token is kept in session storage only and disappears when the browser session closes.
