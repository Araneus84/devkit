...
const DK_BACKUP_KEYS=[...Object.values(STORAGE_KEYS),'devkit_ansible_draft_v1','devkit_ansible_blocks_v2',DK_STORAGE];
...
function dkTransfer(){
 ...
 body.append(dkEl('p','','Backups include your saved content. Keep them with your own files; an app-only copy contains no personal data.'));
