...
const DK_BACKUP_KEYS=[...Object.values(STORAGE_KEYS),'devkit_ansible_draft_v1','devkit_ansible_blocks_v2',DK_STORAGE,'devkit:vim','devkit:editor-mode-v1','devkit:projects:v1','devkit:projects:v2',RP_STORAGE];
