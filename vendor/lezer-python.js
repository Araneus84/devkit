/* Locally bundled Lezer Python parser. See LICENSE.lezer.txt. */
var DP_PARSER=(()=>{const modules={"@lezer/common":function(module,exports,require){
'use strict';
...
"@lezer/lr":function(module,exports,require){
'use strict';
...
"@lezer/highlight":function(module,exports,require){
'use strict';
...
"@lezer/python":function(module,exports,require){
'use strict';
...
}};const cache={};function require(name){if(cache[name])return cache[name].exports;if(!modules[name])throw Error("Missing parser module "+name);const m=cache[name]={exports:{}};modules[name](m,m.exports,require);return m.exports;}return require("@lezer/python").parser;})();
